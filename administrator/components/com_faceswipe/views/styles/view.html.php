...
class FaceSwipeViewStyles extends JView
{
	protected $items;
	...
	{
		JToolBarHelper::title(JText::_('COM_FACESWIPES_MANAGER_STYLES'), 'albums.png');
		JToolBarHelper::addNew('style.add');
		JToolBarHelper::editList('style.edit');
		JToolBarHelper::divider();
		JToolBarHelper::publish('styles.publish', 'JTOOLBAR_PUBLISH', true);
		JToolBarHelper::unpublish('styles.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolBarHelper::divider();
